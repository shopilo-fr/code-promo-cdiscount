#!/usr/bin/env python3
"""
Recuperation des codes promo Cdiscount depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/cdiscount.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/cdiscount.com"
STORE_NAME = "Cdiscount"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Cdiscount depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-cdiscount)"
    }
    try:
